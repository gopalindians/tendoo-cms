            ...
            <div class="page-region-content">
                <div class="body-text">
                    ...
                    <div class="hub_table">
                        ...
                        <p>La restauration désintallera les modules, th&egrave;mes, widgets install&eacute;s et demandera &agrave; chaque modules, widgets et th&egrave;mes de supprimer par la m&ecirc;me occassion les tables et fichiers qui ont &eacute;t&eacute; install&eacute; ult&eacute;rieurement &agrave; leur installation.</p>
                        <h3>Restauration brutale</h3>
                        <p>La restauration supprime tous les fichiers modules, th&egrave;mes et widgets, sans passer par le mode normal de d&eacute;sinstallation. Elle supprime &eacute;galement toutes les tables cr&eacute;es par les modules, th&egrave;mes et widgets, supprime toutes les tables contenue dans la base de donn&eacute;, o&ugrave; les tables qui portent le pr&eacute;fix que vous avez d&eacute;sign&eacute;, restore la base de donn&eacute;e avec certaines informations sauvegard&eacute;s.</p>
                    </div>
                </div>
            </div>
        </div>
