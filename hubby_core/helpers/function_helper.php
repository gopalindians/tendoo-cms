...
if(!function_exists('notice'))
{
	function notice($e,$sort = FALSE)
	{
		...
		$array['page404']		=	'<span class="hubby_error"><i class="icon-blocked"></i> Erreur 404 : </span><br><p>La page que &agrave; laquelle vous souhaitez acc&eacute;der est introuvable ou actuellement indisponible.</span>';
